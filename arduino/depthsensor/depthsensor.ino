...
void setup()
{
  ...
  pinMode(depthOut, OUTPUT);

  digitalWrite(depthOut, HIGH);
...
double getDepth()
{
  ...
  Serial.print("Depth potentiometer send: ");
  Serial.println(analogRead(depthTestPin)*.02938295788);
  return analogRead(depthTestPin)*.02938295788 ;
